!(function (t) {
  ...
  function s(i) {
    ...
    var e = (o[i] = { i: i, l: !1, exports: {} });
    return t[i].call(e.exports, e, e.exports, s), (e.l = !0), e.exports;
  }
  (s.m = t),
    (s.c = o),
    (s.d = function (i, e, t) {
      s.o(i, e) || Object.defineProperty(i, e, { enumerable: !0, get: t });
    }),
    (s.r = function (i) {
  ...
  function (i, e, t) {
    ...
    t(3);
    (o = jQuery)(function () {
      o(".wp-sponsors.slider").length &&
        o(".wp-sponsors.slider").each(function () {
          o(this).slick();
        });
    });
  },
              ...
              ((r = (function () {
                ...
                (r.prototype.buildOut = function () {
                  ...
                  (i.$slides = i.$slider
                    ...
                    (i.$slideTrack =
                      0 === i.slideCount
                        ? d('<div class="slick-track"/>').appendTo(i.$slider)
                        : i.$slides
                ...
                (r.prototype.changeSlide = function (i, e) {
                  ...
                  switch (
                    ...
                    case "index":
                      ...
                      n.slideHandler(n.checkNavigable(l), !1, e),
                  ...
                  return (
                    ...
                    !0 === s.options.swipeToSlide
                      ? (s.$slideTrack
                        ...
                        Math.abs(
                          d(t).attr("data-slick-index") - s.currentSlide
                        ) || 1)
                ...
                (r.prototype.progressiveLazyLoad = function (i) {
                  ...
                  l.length
                    ? ((e = l.first()),
                      ...
                      (s =
                        e.attr("data-sizes") || r.$slider.attr("data-sizes")),
                ...
                (r.prototype.registerBreakpoints = function () {
                  ...
                  if ("array" === d.type(s) && s.length) {
                    ...
                    for (i in s)
                      if (
                        ((t = o.breakpoints.length - 1), s.hasOwnProperty(i))
                      ) {
                ...
                (r.prototype.selectHandler = function (i) {
                  var e = this,
                    t = d(i.target).is(".slick-slide")
                      ? d(i.target)
                      : d(i.target).parents(".slick-slide"),
                    o = parseInt(t.attr("data-slick-index"));
                  o || (o = 0),
                    e.slideCount <= e.options.slidesToShow
                      ? e.slideHandler(o, !1, !0)
                      : e.slideHandler(o);
                }),
